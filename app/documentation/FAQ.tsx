export default function Faqs(){
    ...
    <div className="grid gap-2 font-normal leading-6 text-sm">
        ...
        <p className="text-[#D2CED8CC] font-[400] text-[14px]">Autoswapper will leave unsupported tokens untouched in your wallet. You can manually swap them using the DEX page.</p>
    </div>
    <div className="grid gap-2 leading-6 font-[400] text-[14px]">
    ...
    <div className="grid gap-2 font-[400] text-[14px] leading-6">
