    ...
    <div className="grid gap-5 text-[#DCDFE1]">
      <div className="grid gap-5 font-normal leading-6 text-sm">
        <h3 className="font-semibold text-sm leading-6">
          Swapping Tokens Automatically
        </h3>
        <div>
          <h4 className="">1. Activate Auto-Swap:</h4>
      ...
      <div className="grid gap-5 font-normal leading-6 text-sm">
        <div className="">
          ...
          <ol className="list-disc  pl-4">
            ...
            <li>
              Autoswapper will automatically detect the incoming tokens and
              convert them to the chosen stable token.
            </li>
          </ol>
        </div>
      </div>
      <div className="grid gap-5 font-normal leading-6 text-sm">
        <div className="">
          ...
          <ol className="list-disc pl-4">
            <li>
              Navigate to the Transaction History tab.Navigate to the
              Transaction History tab.
            </li>
            <li>Details include:</li>
            <li>
              Received Token → Swapped Token, Percentage swapped, toggle on and
              off button.
            </li>
          </ol>
        </div>
